//STEP 01
var movies = ["Jurassic World", "Thor Love Thunder", "The Lost City", "Secrets of DumbleDore", "Notebook"];
window.console.log(movies[1]);

//STEP 02

var movies = [];
movies[0] = "Jurassic World";
movies[1] = "Thor Love Thunder";
movies[2] = "The Lost City";
movies[3] = "Secrets of DumbleDore";
movies[4] = "Notebook";
